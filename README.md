...
- <img src="https://buywhere.ai/favicon.ico" height="14" alt="BuyWhere Logo" /> [BuyWhere](https://github.com/BuyWhere/buywhere-mcp) - MCP-friendly shopping and product search for AI agents. Search a multi-market catalog with price comparison and affiliate-ready shopping intent. Remote MCP at `https://mcp.buywhere.ai/mcp`. Install via `npx @buywhere/mcp-server`.
