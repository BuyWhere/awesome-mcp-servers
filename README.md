...
- <img src="https://buywhere.ai/favicon.ico" height="14" alt="BuyWhere Logo" /> **[BuyWhere](https://github.com/BuyWhere/buywhere-mcp)** - Remote MCP server for shopping and product discovery, enabling AI assistants to query real-time product catalogs, compare prices, and find merchant listings.
