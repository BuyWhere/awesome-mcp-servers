...
- <img src="https://www.buywhere.ai/favicon.ico" height="14" alt="BuyWhere Logo" /> [BuyWhere](https://github.com/buywhere/buywhere-mcp-server) - Shopping MCP server for AI agents: product search, merchant comparison, and real-time commerce data via a hosted API.
