...
- <img src="https://buywhere.ai/favicon.ico" height="14" alt="BuyWhere Logo" /> [BuyWhere](https://github.com/BuyWhere/buywhere-mcp) - Cross-border product catalog MCP for AI agents. Search millions of products across Singapore, SEA, and US markets with price comparison and deal discovery. Install via `npx @buywhere/mcp-server`. Hosted at https://api.buywhere.ai/mcp.
